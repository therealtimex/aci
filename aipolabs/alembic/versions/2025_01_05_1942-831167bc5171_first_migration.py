...
Revision ID: 831167bc5171
Revises:
Create Date: 2025-01-05 19:42:34.247339+00:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["integrations.id", "integrations.project_id", "integrations.app_id"],
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "integration_id", "account_name", name="uc_integration_id_account_name"
        ),
        sa.UniqueConstraint(
